export const Bio = {
  ...
  export const experiences = [
    {
      id: 0,
      img: "https://commons.wikimedia.org/wiki/Category:CBRE_Group_logos#/media/File:CBRE_logo.png",
    ...
    },
    {
      ...
      desc: "As a part-time engineer at the ENDEAVR Institute, I played a pivotal role in addressing transportation and healthcare challenges in marginalized communities, leveraging Computer Vision and Deep Learning to enhance an Autonomous Transit System. Using Vision Transformers and YOLO, we achieved a 5% boost in transportation efficiency. Additionally, I led a team of three undergraduates in implementing vehicle tracking with a modified Deep SORT algorithm, resulting in a remarkable 25% accuracy boost in distance estimation using stereo cameras.",
      skills: [
        "Python",
        "Keras",
        "Tensorflow",
